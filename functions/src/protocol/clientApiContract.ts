...
const CATALOG_QUERY_CONTRACT = {
    ...
    sortAliases: {
        ...
        ratingHighToLow: { by: 'ratingAverage', direction: 'desc' as const },
        ratingLowToHigh: { by: 'ratingAverage', direction: 'asc' as const },
        mostPopular: { by: 'popularityScore', direction: 'desc' as const },
        popularityHighToLow: { by: 'popularityScore', direction: 'desc' as const },
        popularityLowToHigh: { by: 'popularityScore', direction: 'asc' as const },
    },
...
export function normalizeActionPayload(gateway: Gateway, action: string, inputPayload: unknown): unknown {
    ...
    if ('sort' in payload) {
        payload.sort = normalizeSort(payload, { by: 'updatedAt', dir: 'desc' });
    }
...
export function toValidationDetails(error: any): {
    issues: string[];
    fields: Array<{ path: string; message: string; type: string }>;
} {
