...
export class Order {
  ...
  @Column({ type: 'varchar', length: 120, nullable: true }) deliveryZoneName!: string | null;
  @Column({ type: 'char', length: 36, nullable: true }) shippingMethodId!: string | null;
  @Column({ type: 'varchar', length: 80, nullable: true }) shippingRecipientName!: string | null;
