...
ACTION_SPECS.profileUpdate = {
    schema: profileUpdatePayload,
    notes: 'Update own profile',
    errorCodes: ['VALIDATION_ERROR', 'ACCOUNT_DISABLED'],
};

ACTION_SPECS.accountDeleteRequest = {
    schema: Joi.object({
        reason: Joi.string().max(500).allow(null, ''),
    }).required(),
    notes: 'Create delete request',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.addressesCreate = {
    schema: addressPayload.required(),
    notes: 'Create address',
    errorCodes: ['VALIDATION_ERROR', 'ACCOUNT_DISABLED'],
};

ACTION_SPECS.addressesUpdate = {
    schema: addressPayload.keys({
...
ACTION_SPECS.addressesSetDefault = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
    }).required(),
    notes: 'Set default address',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.storesGet = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'Get active store',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.storeContextSetMyStore = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'Set selected store',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminStoresGet = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'Admin get store',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.adminStoresCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        name: Joi.string().max(120).required(),
        currency: Joi.string().max(8).optional(),
        taxMode: Joi.string().max(24).optional(),
        supportWhatsApp: Joi.string().max(32).allow(null, ''),
        supportEmail: Joi.string().max(255).allow(null, ''),
        pickupEnabled: Joi.boolean().optional(),
        deliveryEnabled: Joi.boolean().optional(),
    }).required(),
    notes: 'Create store',
    errorCodes: ['VALIDATION_ERROR', 'CONFLICT'],
};

ACTION_SPECS.adminStoresUpdate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        name: Joi.string().max(120).required(),
...
ACTION_SPECS.adminStoresDisable = {
    schema: Joi.object({
        storeId: Joi.string().required(),
...
ACTION_SPECS.adminStoreSettingsGet = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'Get store settings',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};
...
ACTION_SPECS.adminStoreSettingsUpdate = {
    schema: Joi.object({
        ...
        taxMode: Joi.string().max(24).required(),
        supportWhatsApp: Joi.string().max(32).allow(null, ''),
        supportEmail: Joi.string().max(255).allow(null, ''),
        pickupEnabled: Joi.boolean().required(),
        deliveryEnabled: Joi.boolean().required(),
    }).required(),
    notes: 'Update store settings',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminCustomersList = {
    schema: Joi.object({
        limit: Joi.number().integer().min(1).max(100).optional(),
        offset: Joi.number().integer().min(0).optional(),
    }).optional(),
    notes: 'List customers',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminCustomersGet = {
    schema: Joi.object({
...
ACTION_SPECS.adminCustomersDisable = {
    schema: Joi.object({
        uid: Joi.string().required(),
        reason: Joi.string().max(300).allow(null, ''),
    }).required(),
    notes: 'Disable customer',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.adminCustomersSearch = {
    schema: Joi.object({
        query: Joi.string().allow('', null),
        limit: Joi.number().integer().min(1).max(100).optional(),
    }).optional(),
    notes: 'Search customers',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.mediaCreateUploadSpec = {
    schema: uploadPayload,
    notes: 'Client media upload spec creation',
    errorCodes: ['VALIDATION_ERROR', 'CONFIG_ERROR'],
};

ACTION_SPECS.adminMediaCreateUploadSpec = {
    schema: uploadPayload,
    notes: 'Admin media upload spec creation',
    errorCodes: ['VALIDATION_ERROR', 'CONFIG_ERROR'],
};

ACTION_SPECS.mediaFinalizeUpload = {
    schema: finalizePayload,
    notes: 'Client finalize upload',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND', 'FORBIDDEN'],
};

ACTION_SPECS.adminMediaFinalizeUpload = {
    schema: finalizePayload,
    notes: 'Admin finalize upload',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND', 'FORBIDDEN'],
};
...
ACTION_SPECS.publicProductGetById = {
    schema: Joi.object({
...
ACTION_SPECS.publicProductGetBySlug = {
    schema: Joi.object({
        slug: Joi.string().required(),
    }).required(),
    notes: 'Product by slug',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.publicCategoryGetById = {
    schema: Joi.object({
        categoryId: Joi.string().required(),
    }).required(),
    notes: 'Category by id',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.publicCategoryGetBySlug = {
    schema: Joi.object({
        slug: Joi.string().required(),
    }).required(),
    notes: 'Category by slug',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.publicSeoGetPageMeta = {
    schema: Joi.object({
        pageType: Joi.string().required(),
        pageKey: Joi.string().required(),
    }).required(),
    notes: 'SEO meta',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.publicSeoGetLanding = {
    schema: Joi.object({
        slug: Joi.string().required(),
    }).required(),
    notes: 'Landing',
...
ACTION_SPECS.productFavoritesToggle = {
    schema: Joi.object({
        productId: Joi.string().required(),
    }).required(),
    notes: 'Toggle favorite product',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.storeFavoritesToggle = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'Toggle favorite store',
    errorCodes: ['VALIDATION_ERROR'],
};
...
ACTION_SPECS.adminCategoriesCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
...
ACTION_SPECS.adminCategoriesUpdate = {
    schema: Joi.object({
...
ACTION_SPECS.adminBannersCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
...
ACTION_SPECS.adminBannersUpdate = {
    schema: Joi.object({
        id: Joi.string().required(),
...
ACTION_SPECS.adminFeaturedSearchProducts = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        query: Joi.string().allow('', null),
        limit: Joi.number().integer().min(1).max(100).optional(),
    }).required(),
    notes: 'Search products for featured',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminFeaturedSet = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        productIds: Joi.any().required(),
    }).required(),
    notes: 'Set featured',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminProductsCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        categoryId: Joi.string().required(),
        name: Joi.string().required(),
...
ACTION_SPECS.adminProductsUpdate = {
    schema: Joi.object({
        id: Joi.string().required(),
        categoryId: Joi.string().optional(),
        name: Joi.string().optional(),
...
ACTION_SPECS.adminProductImagesList = {
    schema: Joi.object({
        productId: Joi.string().required(),
    }).required(),
    notes: 'list images',
...
ACTION_SPECS.adminProductImagesRemove = {
    schema: idSchema,
    notes: 'remove image',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminProductImagesReorder = {
    schema: Joi.object({
        productId: Joi.string().required(),
        items: Joi.any().required(),
    }).required(),
    notes: 'reorder images',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminProductSpecsList = {
    schema: Joi.object({
        productId: Joi.string().required(),
    }).required(),
    notes: 'list specs',
...
ACTION_SPECS.adminProductSpecsCreate = {
    schema: Joi.object({
        productId: Joi.string().required(),
        specKey: Joi.string().required(),
...
ACTION_SPECS.adminProductSpecsUpdate = {
    schema: Joi.object({
        id: Joi.string().required(),
        productId: Joi.string().required(),
        specKey: Joi.string().optional(),
        specValue: Joi.string().optional(),
        sortOrder: Joi.number().integer().optional(),
    }).required(),
    notes: 'update spec',
    errorCodes: ['VALIDATION_ERROR'],
...
ACTION_SPECS.adminProductSpecsDelete = {
    schema: idSchema,
    notes: 'delete spec',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminProductVariantsList = {
    schema: Joi.object({
        productId: Joi.string().required(),
    }).required(),
    notes: 'list variants',
...
ACTION_SPECS.adminProductVariantsCreate = {
    schema: Joi.object({
        productId: Joi.string().required(),
        sku: Joi.string().required(),
        priceCents: Joi.number().integer().required(),
        stockQty: Joi.number().integer().required(),
...
ACTION_SPECS.adminProductVariantsUpdate = {
    schema: Joi.object({
        id: Joi.string().required(),
        productId: Joi.string().required(),
        sku: Joi.string().optional(),
        priceCents: Joi.number().integer().optional(),
        stockQty: Joi.number().integer().optional(),
        attributes: Joi.any().optional(),
        status: Joi.string().optional(),
    }).required(),
...
ACTION_SPECS.adminProductVariantsDelete = {
    schema: idSchema,
    notes: 'delete variant',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminProductVariantsBulkStockUpdate = {
    schema: Joi.object({
        items: Joi.any().required(),
    }).required(),
    notes: 'bulk stock',
...
ACTION_SPECS.adminInventoryAdjust = {
    schema: Joi.object({
        variantId: Joi.string().required(),
        deltaQty: Joi.number().integer().required(),
        reason: Joi.string().allow(null, ''),
    }).required(),
    notes: 'adjust inventory',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminInventoryHistory = {
    schema: Joi.object({
        variantId: Joi.string().required(),
    }).required(),
    notes: 'inventory history',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminHomeSectionsGet = {
    schema: idSchema,
    notes: 'get section',
    errorCodes: ['VALIDATION_ERROR'],
};
...
ACTION_SPECS.adminHomeSectionsUpdate = {
    schema: Joi.object({
        id: Joi.string().required(),
...
ACTION_SPECS.adminHomeSectionsReorder = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        items: Joi.any().required(),
    }).required(),
    notes: 'reorder section',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminSeoGet = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        pageType: Joi.string().required(),
        pageKey: Joi.string().required(),
...
ACTION_SPECS.adminLandingPagesGet = {
    schema: idSchema,
    notes: 'get landing page',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminLandingPagesCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        slug: Joi.string().required(),
        title: Joi.string().required(),
    ...
    notes: 'create landing',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminLandingPagesUpdate = {
    schema: Joi.object({
        id: Joi.string().required(),
        slug: Joi.string().optional(),
        title: Joi.string().optional(),
    ...
    notes: 'update landing',
    errorCodes: ['VALIDATION_ERROR'],
};

const phase4ClientAny = [
    'cartGet',
    'cartClear',
    'cartRemoveCoupon',
    'notificationsList',
...
ACTION_SPECS.shippingQuoteDelivery = {
    schema: Joi.object({
        lat: Joi.number().required(),
        lng: Joi.number().required(),
    }).required(),
...
ACTION_SPECS.checkoutPreview = {
    schema: Joi.any().optional(),
    notes: 'phase4',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.notificationsRegisterToken = {
    schema: Joi.object({
...
ACTION_SPECS.notificationsMarkRead = {
    schema: Joi.object({
        id: Joi.string().required(),
    }).required(),
    notes: 'phase4',
...
ACTION_SPECS.notificationsDelete = {
    schema: Joi.object({
        id: Joi.string().required(),
    }).required(),
    notes: 'phase4',
...
ACTION_SPECS.marketingCapture = {
    schema: Joi.object({
        ...
        dedupeKey: Joi.string().allow(null, ''),
    }).required(),
    notes: 'phase4',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.alertsUpdatePrefs = {
    schema: Joi.object({
        backInStock: Joi.boolean().required(),
        priceDrop: Joi.boolean().required(),
    }).required(),
    notes: 'phase4',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.alertsSubscribeBackInStock = {
    schema: Joi.object({
        productId: Joi.string().required(),
    }).required(),
    notes: 'phase4',
...
ACTION_SPECS.supportCreateTicket = {
    schema: Joi.object({
        subject: Joi.string().required(),
        message: Joi.string().required(),
        mediaAssetId: Joi.string().allow(null, ''),
    }).required(),
    notes: 'phase4',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.supportGetTicket = {
    schema: Joi.object({
...
ACTION_SPECS.supportAddMessage = {
    schema: Joi.object({
        ticketId: Joi.string().required(),
        message: Joi.string().required(),
        mediaAssetId: Joi.string().allow(null, ''),
...
ACTION_SPECS.supportCloseTicket = {
    schema: Joi.object({
        ticketId: Joi.string().required(),
    }).required(),
    notes: 'phase4',
...
ACTION_SPECS.adminDiscountsPreviewAudienceCount = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        audience: Joi.any().required(),
    }).required(),
    notes: 'phase4',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminNotificationsSend = {
    schema: Joi.object({
        target: Joi.string().valid('store', 'all').required(),
        title: Joi.string().required(),
        body: Joi.string().required(),
        limit: Joi.number().integer().optional(),
    }).required(),
    notes: 'Send admin notification',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminNotificationsList = {
    schema: Joi.object({
        limit: Joi.number().integer().optional(),
    }).optional(),
    notes: 'List admin notifications history',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminLoyaltyGetSettings = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'phase4',
...
ACTION_SPECS.adminLoyaltyUpdateSettings = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        pointsPerCurrencyUnit: Joi.number().integer().required(),
        redeemStepPoints: Joi.number().integer().required(),
        redeemStepValueCents: Joi.number().integer().required(),
    }).required(),
    notes: 'phase4',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminLoyaltyAdjustUserPoints = {
    schema: Joi.object({
        uid: Joi.string().required(),
        storeId: Joi.string().required(),
        pointsDelta: Joi.number().integer().required(),
    }).required(),
    notes: 'phase4',
    errorCodes: ['VALIDATION_ERROR'],
};
...
ACTION_SPECS.adminPostPurchaseRunsList = {
    schema: Joi.object({
        limit: Joi.number().integer().optional(),
    }).optional(),
    notes: 'phase4',
...
ACTION_SPECS.adminCouponsCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
...
ACTION_SPECS.adminCouponsUpdate = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
        code: Joi.string().max(64).required(),
        discountType: Joi.string().valid('percentage', 'fixed').required(),
    ...
    notes: 'Update coupon',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND', 'CONFLICT'],
};

ACTION_SPECS.adminCouponsDisable = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
    }).required(),
    notes: 'Disable coupon',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.adminCashbackList = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'List cashback rules',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminCashbackGet = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
    }).required(),
    notes: 'Get cashback rule',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.adminCashbackCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        name: Joi.string().max(120).required(),
        percent: Joi.number().min(0).max(100).required(),
        rules: Joi.any().allow(null).optional(),
        status: Joi.string().valid('active', 'disabled').optional(),
    }).required(),
    notes: 'Create cashback rule',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminCashbackUpdate = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
        name: Joi.string().max(120).required(),
        percent: Joi.number().min(0).max(100).required(),
    ...
    notes: 'Update cashback rule',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.adminCashbackDisable = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
    }).required(),
    notes: 'Disable cashback rule',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.adminDiscountsList = {
    schema: Joi.object({
        storeId: Joi.string().required(),
    }).required(),
    notes: 'List discounts',
    errorCodes: ['VALIDATION_ERROR'],
};

ACTION_SPECS.adminDiscountsGet = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
    }).required(),
    notes: 'Get discount',
...
ACTION_SPECS.adminDiscountsCreate = {
    schema: Joi.object({
        storeId: Joi.string().required(),
        name: Joi.string().max(120).required(),
        percent: Joi.number().min(0).max(100).required(),
        audience: Joi.any().allow(null).optional(),
        status: Joi.string().valid('active', 'disabled').optional(),
    }).required(),
...
ACTION_SPECS.adminDiscountsUpdate = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
        name: Joi.string().max(120).required(),
        percent: Joi.number().min(0).max(100).required(),
    ...
    notes: 'Update discount',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};

ACTION_SPECS.adminDiscountsDisable = {
    schema: Joi.object({
        id: Joi.string().guid({ version: ['uuidv4', 'uuidv5'] }).required(),
    }).required(),
    notes: 'Disable discount',
    errorCodes: ['VALIDATION_ERROR', 'NOT_FOUND'],
};
