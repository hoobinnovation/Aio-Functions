export const ADMIN_ACTIONS_SOT = [
  ...
  'adminProductAliasesList','adminProductAliasGet','adminProductAliasUpsert','adminProductAliasDelete',
  ...
  'adminPurchaseOrdersList','adminPurchaseOrdersGet','adminPurchaseOrdersCreate','adminPurchaseOrdersUpdate','adminPurchaseOrdersSubmit','adminPurchaseOrdersApprove','adminPurchaseOrdersCancel','adminPurchaseOrdersReceive',
  'adminGoodsReceiptsList','adminGoodsReceiptsGet','adminGoodsReceiptsCreate',
  'adminStockMovementsList',
  'adminInventoryBatchesList','adminInventoryBatchesUpdate',
  ...
  'adminSitemapGet','adminSitemapRegenerate',
