export const ADMIN_ACTIONS_SOT = [
  ...
  'adminSuppliersList','adminSuppliersCreate','adminSuppliersUpdate','adminSuppliersDisable',
  'adminWarehousesList','adminWarehousesCreate','adminWarehousesUpdate','adminWarehousesDisable',
  'adminPurchaseOrdersList','adminPurchaseOrdersGet','adminPurchaseOrdersCreate','adminPurchaseOrdersSubmit','adminPurchaseOrdersApprove','adminPurchaseOrdersCancel','adminPurchaseOrdersReceive',
  'adminPosSessionsOpen','adminPosSessionsClose','adminPosSessionsList','adminPosSalesCreate','adminPosSalesGet','adminPosSalesList','adminPosReturnsCreate','adminPosReturnsGet','adminPosReturnsList',
  ...
  'adminAccountingGeneralLedger','adminAccountingTrialBalance','adminAccountingProfitAndLoss','adminAccountingBalanceSheet','adminAccountingCashFlowFoundation','adminAccountingPeriodCloseValidate','adminAccountingPeriodClose','adminAccountingPeriodReopen',
  'adminArDocumentsList','adminArDocumentsCreate','adminArDocumentsSettle',
  'adminApDocumentsList','adminApDocumentsCreate','adminApDocumentsSettle',
  'adminTaxCodesList','adminTaxCodesCreate','adminTaxAssignmentsCreate',
  'adminFinancialAccountsList','adminFinancialAccountsCreate',
  'adminReconciliationSessionsCreate','adminReconciliationTransactionsRegister','adminReconciliationTransactionsMatch',
