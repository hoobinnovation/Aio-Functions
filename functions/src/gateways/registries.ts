...
import { adminInsuranceList, adminInsuranceGet, adminInsuranceAddItem, adminInsuranceUpdateItem, adminInsuranceRemoveItem, adminInsuranceLockQuote, adminInsuranceSendQuote, adminInsuranceSetShipmentTracking } from '../actions/admin/insuranceAdminActions';
import { adminInventoryImportCreateBatch, adminInventoryImportPreview, adminInventoryImportGetUnmappedPrefixes, adminInventoryImportResolvePrefixes, adminInventoryImportApply, adminInventoryImportGet } from '../actions/admin/inventoryImportAdminActions';
...
add(registryAdmin,'adminEdgeSyncIngest',adminEdgeSyncIngest as ActionHandler);
